...
export default function OrderDetailsPage() {
     ...
     *
     * IMPORTANT:
     * We use item._id here, NOT item.product._id.
     *
     * item._id = the specific item inside this order
     * item.product._id = the actual product ID
     */
    const handleReturnRequest = (item: OrderItem) => {
        if (!order?._id || !item?._id) {
            toast.error("تعذر فتح طلب الإرجاع")
            return
        }

        router.push(
            `/returns/new?orderId=${encodeURIComponent(order._id)}&itemId=${encodeURIComponent(item._id)}`
        )
    }
        ...
        return (
            <div className="container mx-auto py-12 px-4 text-center">
                ...
                <p className="text-muted-foreground mb-6 text-sm sm:text-base">
                    عذراً، لا يمكن العثور على تفاصيل الطلب المطلوبة
                </p>
                        ...
                        <CardHeader className="p-4 sm:p-6 pb-3 sm:pb-4">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2">
                                ...
                                <div className="flex items-center gap-2 self-start sm:self-auto">
                                    ...
                                    <Badge
                                        className={`${deliveryStatusInfo.color} flex items-center gap-1.5 py-1 px-2.5 text-xs font-medium`}
                                    >
                                        {deliveryStatusInfo.icon}

                                        <span>
                                            {deliveryStatusInfo.text}
                                        </span>
                                    </Badge>
                                ...
                                <div className="divide-y divide-gray-100">
                                    ...
                                    {order.items.map(
                                        (item) => (
                                            <div
                                                key={item._id}
                                                className="flex gap-3 sm:gap-4 py-4 first:pt-0 last:pb-0"
                                            >
                                                    ...
                                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mt-2">
                                                        ...
                                                        {order.deliveryStatus === "delivered" && (
                                                            <Button
                                                                ...
                                                                className="w-full sm:w-auto h-9 rounded-lg border-orange-200 text-orange-600 hover:bg-orange-50 hover:text-orange-700 gap-1.5"
                                                            >
                        ...
                        <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0 text-sm">
                            ...
                            <div className="space-y-3.5">
                                ...
                                <div className="flex justify-between items-center gap-2">
                                    ...
                                    <Badge
                                        className={`${paymentStatusInfo.color} font-normal text-xs px-2 py-0`}
                                    >
                                        {
