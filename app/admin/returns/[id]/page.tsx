...
export default function AdminReturnDetailsPage() {
    ...
    const handleStatusUpdate = async (newStatus: string) => {
        ...
        try {
            ...
            toast.success('تم تحديث حالة طلب الإرجاع بنجاح');
            setShowRejectionForm(false);
            setRejectionReason("");
        } catch (error: any) {
            console.error('Error updating return status:', error);
            toast.error(error.response?.data?.message || 'فشل في تحديث حالة طلب الإرجاع');
        } finally {
                ...
                <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    {returnRequest.user?.phone && (
                                        <div>
                                            <p className="text-slate-500 mb-1">رقم الهاتف</p>
                                            <p className="font-semibold text-slate-800">
                                                {returnRequest.user.phone}
                                            </p>
                                        </div>
                            ...
                            <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                                <h2 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                                    <Edit className="w-5 h-5 text-[#1a4fba]" />
                                    إجراءات المشرف
                                </h2>
                                ...
                                <div className="space-y-4">
                                    {/* Status Update */}
                                    <div className="flex items-center gap-3">
                                        <Label htmlFor="status" className="text-sm font-medium text-slate-700">تحديث الحالة:</Label>
                                        <Select 
                                    ...
                                    {showRejectionForm && (
                                        <div className="w-full">
                                            ...
                                            <div className="flex gap-2 mt-2">
                                                ...
                                                >
                                                    {updatingStatus ? 'جاري...' : 'تأكيد الرفض'}
                                                </Button>
                                                <Button
                                                    variant="outline"
                                                    onClick={() => {
