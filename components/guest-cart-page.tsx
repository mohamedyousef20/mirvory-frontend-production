              ...
              <div className="space-y-4">
                {items.map((item, idx) => (
                  <div
                    ...
                    className={`bg-white rounded-2xl border p-5 shadow-sm hover:shadow-md transition-all duration-300 group ${item.available === false ? "border-rose-200 bg-rose-50/50" : "border-slate-100"
                      }`}
                  >
